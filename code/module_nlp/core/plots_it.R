...
switch (args,
  ...
  "rdm_osgood_col" = rdm_corr(c("it/sighted/colors_spearman1.csv",
                              ...
                              file_name = "supp1C.svg",
                              plabels = c("", "", "", "")),
  "rdm_osgood_em" = rdm_corr(c("it/sighted/emotions_spearman1.csv",
                               "it/sighted/emotions_spearman2.csv"),
                             y_position = 0.6, ylim = c(-0.1,0.9),
                             file_name = "supp1D.svg",
                             plabels = c("****", "****", "", "")),
  "rdm_osgood_both" = rdm_corr(c("it/sighted/osgoodspace1.csv",
                             ...
                             plabels = c("**", "", "", "")),
  "rdm_osgood_col_blind" = rdm_corr(c("it/blind/colors_spearman1.csv",
                                "it/blind/colors_spearman2.csv"),
                              y_position = 0.6, ylim = c(-0.2,0.9),
                              file_name = "supp2A.svg",
                              plabels = c("", "", "", "")),
  "rdm_osgood_em_blind" = rdm_corr(c("it/blind/emotions_spearman1.csv",
                               "it/blind/emotions_spearman2.csv"),
                             y_position = 0.6, ylim = c(-0.1,0.9),
                             file_name = "supp2B.svg",
                             plabels = c("****", "****", "", "")),
  "rdm_osgood_both_blind" = rdm_corr(c("it/blind/osgoodspace1.csv",
                               "it/blind/osgoodspace2.csv"),
                             y_position = 0.6, ylim = c(-0.1,0.9),
                             file_name = "supp2C.svg",
                             plabels = c("**", "", "", "")),
)
